...
class CrudDemo2 extends StatefulWidget {
  const CrudDemo2({super.key});

  @override
  State<CrudDemo2> createState() => _CrudDemo2State();
}

class _CrudDemo2State extends State<CrudDemo2> {
  // final List users = [
  //   {'name': 'Tom', 'age': 20},
  //   {'name': 'Lisa', 'age': 25},
  //   {'name': 'Peter', 'age': 19}
